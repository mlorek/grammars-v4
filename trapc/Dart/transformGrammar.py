...
rename('CLexerBase.dart', [
    ('CLexerBase', 'TrapCLexerBase'),
])
os.rename('CLexerBase.dart', 'TrapCLexerBase.dart')

rename('CParserBase.dart', [
    ('CParserBase', 'TrapCParserBase'),
    ('CParser',     'TrapCParser'),
    ('CLexer',      'TrapCLexer'),
])
os.rename('CParserBase.dart', 'TrapCParserBase.dart')

rename('ErrorListener.dart', [
    ('CLexer', 'TrapCLexer'),
])
